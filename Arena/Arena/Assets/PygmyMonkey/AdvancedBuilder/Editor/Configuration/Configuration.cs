...
namespace PygmyMonkey.AdvancedBuilder
{
	...
	public class Configuration : IEquatable<Configuration>
	{
		...
		public void applyConfiguration()
		{
			...
			{
				bool isValid = buildTargetGroup != BuildTargetGroup.Unknown;

				#pragma warning disable 618
				#if UNITY_5_4_OR_NEWER
				isValid = isValid && buildTargetGroup != BuildTargetGroup.WP8 && buildTargetGroup != BuildTargetGroup.BlackBerry;
				#endif
				#if UNITY_5_5_OR_NEWER
				isValid = isValid && buildTargetGroup != BuildTargetGroup.PS3 && buildTargetGroup != BuildTargetGroup.XBOX360;
				#endif
		...
		{
			return "/Builds/" + getBuildDestinationPath(advancedSettings, buildDate, productParameters) + "" + platformArchitecture.binarySuffix;
		}
