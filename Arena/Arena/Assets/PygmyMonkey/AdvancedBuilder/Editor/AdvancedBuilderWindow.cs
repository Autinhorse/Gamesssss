...
namespace PygmyMonkey.AdvancedBuilder
{
	public class AdvancedBuilderWindow : PMEditorWindow
	{
		...
		public static string VersionName = "1.5.4";
		...
		*/
		...
		{
			m_advancedBuilder = PMUtils.CreateScriptableObject<AdvancedBuilder>(AdvancedBuilder.GetPackagePath() + "AdvancedBuilder/Editor/AdvancedBuilder.asset");
			m_appParameters = PMUtils.CreateScriptableObject<AppParameters>(AdvancedBuilder.GetPackagePath() + "AdvancedBuilder/Resources/AppParameters.asset");
		}
	}
}