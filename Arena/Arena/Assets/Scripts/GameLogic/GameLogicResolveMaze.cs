...
public class GameLogicResolveMaze : GameLogic {
    ...
    public override void SetGameController( GameController controller ) {
        ...
        _gameController.SetGameDescription1( 7, "Help me to exit." );
        ...
        MapBlockSize = (int) _gameController.boardHeight/(_mapWidth+7);
        ...
        rect.localPosition = new Vector3( _gameController.boardWidth*3/-10, _gameController.boardHeight*25/-80, 0 );
        ...
        rect.sizeDelta =  new Vector2( buttonSize, buttonSize );
        rect.localPosition = new Vector3( _gameController.boardWidth*1/-10, _gameController.boardHeight*25/-80, 0 );
        rect.localScale = Vector3.one;
        _goList.Add( button1.gameObject );
