...
namespace Fenderrio.ImageWarp
{
	...
	public class RawImageWarp : RawImage {
		...
		{
			if (ConvertImageToUIRawImageWarp (Selection.activeGameObject))
			{
				Debug.Log (Selection.activeGameObject.name + "'s RawImage component converted into a UIRawImageWarp component");
			}
		}

		public static bool ConvertImageToUIRawImageWarp(GameObject imageObject)
		{
			...
			RawImageWarp.CopyComponent(imageComponent, imageWarpComponent);

			DestroyImmediate (imageComponent);

			RawImageWarp newImageWarpComponent = imageObject.AddComponent<RawImageWarp> ();

			RawImageWarp.CopyComponent (imageWarpComponent, newImageWarpComponent);
		...
		static void CopyComponent(RawImage imageFrom, RawImage imageTo)
		{
