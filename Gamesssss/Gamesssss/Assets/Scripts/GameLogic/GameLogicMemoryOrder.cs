...
public class GameLogicMemoryOrder : GameLogic {
    ...
    public override void SetGameController( GameController controller ) {
        ...
        _gameController.SetGameName( "ORDER" );
        _gameController.SetGameDescription1( 0, "Remember the numbers on tiles." );
        ...
        _timer = 2+(difficulty/2)*0.5f;

        _blockNumber = 4+((difficulty+1)/2);
    ...
    public override void FixedUpdate() {
        if(_status==Status_Remebering) {
            ...
            if(_timer<0) {
                ...
                _gameController.SetGameDescription1( "Tap tiles in order." );
