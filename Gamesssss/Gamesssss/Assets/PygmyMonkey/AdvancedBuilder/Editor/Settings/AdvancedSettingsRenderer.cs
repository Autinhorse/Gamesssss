...
namespace PygmyMonkey.AdvancedBuilder
{
	public class AdvancedSettingsRenderer : IDefaultRenderer
	{
		...
		public void drawInspector()
		{
			...
			{
				EditorGUILayout.SelectableLabel("$BUILD_DATE", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$RELEASE_TYPE", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$PLATFORM", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$DISTRIB_PLATFORM", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$ARCHITECTURE", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$TEXT_COMPRESSION", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$PRODUCT_NAME", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$BUNDLE_VERSION", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$BUNDLE_IDENTIFIER", GUILayout.Width(145f), GUILayout.Height(16f));
			...
			EditorGUILayout.BeginHorizontal();
			{
				EditorGUILayout.SelectableLabel("$BUILD_NUMBER", GUILayout.Width(145f), GUILayout.Height(16f));
				EditorGUILayout.LabelField("The build number");
			}
			EditorGUILayout.EndHorizontal();
		...
		private bool isCustomValid(string thePath)
		{
			string path = thePath
				...
				.Replace("$BUILD_NUMBER", string.Empty);
